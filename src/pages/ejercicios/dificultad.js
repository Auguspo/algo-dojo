  ...
  return (
    <Layout>
      <div className="container mx-auto py-8 px-4"> {/* Añadimos padding horizontal para dispositivos móviles */}
        <h1 className="text-2xl font-bold mb-4 text-center">Ejercicios por dificultad</h1> {/* Reducimos el tamaño del título y lo centramos */}
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4"> {/* Utilizamos una sola columna en dispositivos móviles */}
          {ejerciciosPorDificultad.map((ejerciciosEnDificultad, index) => (
            <div key={index} className="bg-gray-200 p-4 rounded-md">
              <h2 className="text-lg font-bold mb-2 text-black">Dificultad {index + 1}</h2>
